...
if(isset($_POST['save_medicine'])) {
 ...
 $message = 'لا يمكن تقديم النموذج الفارغ.';
}
...
include './config/sidebar.php';?>  
      ...
      <section class="content">
        ...
        <div class="card card-outline card-primary rounded-0 shadow">
          <div class="card-header">
            <h3 class="card-title">اضافة دواء جديد</h3>
            ...
            <form method="post">
             <div class="row">
              ...
              <div class="col-lg-1 col-md-2 col-sm-2 col-xs-2">
                ...
                name="save_medicine" class="btn btn-primary btn-sm btn-flat btn-block">اضافة</button>
              </div>
            </div>
          </form>
        </div>
    ...
    <section class="content">
      ...
      <div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
          <h3 class="card-title">جميع الادوية</h3>
      ...
      if(medicineName !== '') {
        $.ajax({
          ...
          success: function (count, status, xhr) {
            if(count > 0) {
              showCustomMessage("تم تخزين اسم الدواء هذا بالفعل. الرجاء اختيار اسم آخر");
