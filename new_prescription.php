...
<head>
 ...
 <title>نظام ادارة العيادة الطبية</title>
...
include './config/sidebar.php';?>  
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="card card-outline card-primary rounded-0 shadow">
          <div class="card-header">
            <h3 class="card-title">اضافة تقرير جديد</h3>
      ...
      <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
        <label>الحالة المرضية اثناء المراجعة</label>
  ...
  <div class="row">
    ...
    <div class="col-md-2">
      ...
      class="btn btn-primary btn-sm btn-flat btn-block">حفظ التقرير</button>
    </div>
  </div>
</form>
