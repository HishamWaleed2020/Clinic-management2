...
include './config/sidebar.php';?>  
      ...
      <section class="content">
        ...
        <div class="card card-outline card-primary rounded-0 shadow">
          <div class="card-header">
            <h3 class="card-title">اضف تفاصيل دواء</h3>
            ...
            <form method="post">
              <div class="row">
                ...
                <div class="col-lg-1 col-md-2 col-sm-4 col-xs-12">
                  ...
                  class="btn btn-primary btn-sm btn-flat btn-block">حفظ</button>
                </div>
              </div>
            </form>
          </div>
  ...
  <section class="content">
      ...
      <div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
          <h3 class="card-title">تفاصيل الادوية</h3>
